...
import { SummaryResponseDto,MastercardSummaryQueryParams } from 'src/app/core/models/invoice.models';
...
export class MastercardSummaryComponent implements OnInit {
   ...
   canAccessMastercard = false;
    ...
    exportSummaryToCsv(): void {
       console.log('Exporting Mastercard summary to CSV...');
          ...
          this.billingService.getMasterCardChargesSummary(params).subscribe({
            next: (data) => {
              ...
              if (
                ...
                this.downloadCsv(csv, 'mastercard-summary-report.csv');
              } else {
    ...
    prepareChartData(): void {
      ...
      this.chartOptions = {
        ...
        colors: ['#F7B600', '#1a1f71', '#00E396', '#FF4560', '#775DD0'],
        legend: {
          show: true,
          position: 'top',
