...
import { MastercardInvoiceDetailDto } from 'src/app/core/models/invoice.models';
...
@Component({
  selector: 'app-mastercard-anomaly-detail',
   standalone: true,
   imports: [CommonModule,SharedModule],
  templateUrl: './mastercard-anomaly-detail.component.html',
  styleUrl: './mastercard-anomaly-detail.component.scss'
})
export class MastercardAnomalyDetailComponent implements OnInit {
  ...
  loadInvoice(invoiceId: string): void {
    this.isLoading = true;
    this.billingService.getMastercardInvoiceById(invoiceId).subscribe({
      next: (invoice) => {
